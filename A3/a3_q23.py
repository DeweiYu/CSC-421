...
dispnea_net = BayesNet([
    ('A', '', 0.01),  # Probability of Asthma
    ('S', '', 0.5),   # Probability of Smoking
    ('T', 'A', {True: 0.05, False: 0.01}),  # Probability of Tuberculosis given Asthma
    ('L', 'S', {True: 0.1, False: 0.01}),   # Probability of Lung Cancer given Smoking
    ('B', 'S', {True: 0.6, False: 0.3}),    # Probability of Bronchitis given Smoking
    ('E', ['T', 'L'], {  # Probability of either Tuberculosis or Lung Cancer
        (True, True): 1, (True, False): 1,
        (False, True): 1, (False, False): 0
    }),
    ('X', 'E', {True: 0.98, False: 0.05}),  # Probability of Positive X-ray given Evidence
    ('D', ['E', 'B'], {  # Probability of Dyspnea given Evidence and Bronchitis
...
cpt_l_true = dispnea_net.variable_node('L').cpt[(True,)]
cpt_l_false = dispnea_net.variable_node('L').cpt[(False,)]
...
ea_result = enumeration_ask('D', {'A': True, 'X': True}, dispnea_net)
rs_result = rejection_sampling('D', {'A': True, 'X': True}, dispnea_net, 100000)
lw_result = likelihood_weighting('D', {'A': True, 'X': True}, dispnea_net, 100000)
